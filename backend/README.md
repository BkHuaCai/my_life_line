...
- **共享时间线**：后端新建或由本地时间线复制一份转为共享，他人可往里提交动态，创建者审核是否展示
...
shared_event     共享时间线上的动态（author_account_id 提交者, status pending/approved/rejected, reviewed_by, reviewed_at）
...
- 审核前动态**只对创建者 + 提交者本人**可见；审核后对所有人可见
